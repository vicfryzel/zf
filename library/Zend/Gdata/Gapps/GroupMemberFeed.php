...
/**
 * @see Zend_Gdata_Gapps_GroupMemberEntry
 */
require_once 'Zend/Gdata/Gapps/GroupMemberEntry.php';

/**
 * Data model for a collection of Google Apps group member entries, usually
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Gdata_Gapps_GroupMemberFeed extends Zend_Gdata_Feed
{

    protected $_entryClassName = 'Zend_Gdata_Gapps_GroupMemberEntry';
    protected $_feedClassName = 'Zend_Gdata_Gapps_GroupMemberFeed';
}
