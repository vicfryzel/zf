...
/**
 * @see Zend_Gdata_Gapps_CalendarResourceEntry
 */
require_once 'Zend/Gdata/Gapps/CalendarResourceEntry.php';

/**
 * Data model for a collection of Google Apps calendar resource entries, usually
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Gdata_Gapps_CalendarResourceFeed extends Zend_Gdata_Feed
{
    protected $_entryClassName = 'Zend_Gdata_Gapps_CalendarResourceEntry';
    protected $_feedClassName = 'Zend_Gdata_Gapps_CalendarResourceFeed';
}
