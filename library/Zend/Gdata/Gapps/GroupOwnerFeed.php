...
/**
 * Data model for a collection of Google Apps group owner entries, usually
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Gdata_Gapps_GroupOwnerFeed extends Zend_Gdata_Feed
{

    protected $_entryClassName = 'Zend_Gdata_Gapps_GroupOwnerEntry';
    protected $_feedClassName = 'Zend_Gdata_Gapps_GroupOwnerFeed';
}
